...
struct ImGuiIO
{
    ...
    ImGuiKeyModFlags KeyMods;                   // KeyLock mods flags (same as io.KeyCtrl/KeyShift/KeyAlt/KeySuper but merged into flags), updated by NewFrame()
...
struct ImGuiInputTextCallbackData
{
    ...
    ImGuiKey            EventKey;       // KeyLock pressed (Up/Down/TAB)            // Read-only    // [Completion,History]
...
// Types are NOT stored, so it is up to you to make sure your KeyLock don't collide with different types.
struct ImGuiStorage
{
    // [Internal]
